                        ...
                        <div class="col-md-8">
                            <div class="single-video-left">
                                <div class="single-video">
                                    <video width="100%" height="315%" src="vidtutor/vid/6.mp4" frameborder="5" controls></video>
                                </div>
                                <div class="single-video-title box mb-3">
                                    <h2><a href="#">Berenang </a><span title="" data-placement="top" data-toggle="tooltip" data-original-title="Verified"><i class="fas fa-check-circle text-success"></i></span></h2>
    ...
    Back To Main <i class="fa fa-caret-down" aria-hidden="true"></i>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="video-card video-card-list">
                                            ...
                                            <div class="video-title">
                                                <a href="{{url('vidtutor.Tutor8')}}">Bersepeda</a>
                                            </div>
                                            <div class="video-page text-success">
                                                Blueray Available <a title="" data-placement="top" data-toggle="tooltip" href="#" data-original-title="Verified"><i class="fas fa-check-circle text-success"></i></a>
                                            </div>
