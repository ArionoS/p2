   ...
   // }
    ...
    public function store(Request $request)
    {
        ...
        if($request->file('cover')) {
            ...
            $request->file('cover')->move("images/nutrisi", $fileName);
            $cover = $fileName;
        } else {
            $cover = NULL;
        }
        ...
        return redirect()->route('nutrisi.index');
    ...
    public function show($id)
    {
        ...
        $data = Nutrisi::findOrFail($id);

        return view('nutrisi.show', compact('data'));
    }
    ...
    {   
        ...
        $data = Nutrisi::findOrFail($id);
        return view('nutrisi.edit', compact('data'));
    }
